...
namespace OpenMods.Server.Migrations
{
    ...
    [Migration("20260207190946_AddSupportedGamesToMod")]
    partial class AddSupportedGamesToMod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GameMod", b =>
                {
                    ...
                    b.HasKey("ModsId", "SupportedGamesId");
            ...
            modelBuilder.Entity("OpenMods.Server.Models.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("OpenMods.Server.Models.ReleaseAsset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("GameMod", b =>
                {
                    ...
                    b.HasOne("OpenMods.Server.Models.Game", null)
                        .WithMany()
            ...
            modelBuilder.Entity("GameRelease", b =>
                {
                    b.HasOne("OpenMods.Server.Models.Release", null)
                        .WithMany()
            ...
            modelBuilder.Entity("OpenMods.Server.Models.ReleaseAsset", b =>
                {
                    b.HasOne("OpenMods.Server.Models.Release", "Release")
                        .WithMany("Assets")
